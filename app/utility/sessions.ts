...
import { STAccessTokenPayload } from "../types";

/*
  https://supertokens.com/docs/passwordless/nextjs/app-directory/server-components-requests
*/

const client = jwksClient({
  jwksUri: `${process.env.NEXT_SERVER_SUPERTOKENS_CONNECTION_URI}/.well-known/jwks.json`,
});
...
export async function getSSRSessionHelper(): Promise<{
  accessTokenPayload: JwtPayload | STAccessTokenPayload | undefined;
  hasToken: boolean;
